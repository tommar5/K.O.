...
sed -i "s/database_user:.*$/database_user: root/" /var/www/app/config/parameters.yml
sed -i "s/database_password:.*$/database_password: $MYSQL_ENV_MYSQL_ROOT_PASSWORD/" /var/www/app/config/parameters.yml
...
php /var/www/app/console doctrine:migrations:migrate --no-interaction

echo "[info] Re-install assets"
php /var/www/app/console assets:install httpdocs

chown -R www:www /var/www/app/*
chown -R www:www /var/www/httpdocs/*
chown -R www:www /var/www/assets/*
